...
class Dictionary:
    ...
    def build_custom_dictionary_manual(self):
        ...
        self.custom_dict["otra"] = [["other", "adjective"], ["another", "adjective"], ["one more", "adjective"], ["a second", "adjective"], ["next", "adjective"], ["following", "adjective"]]
        self.custom_dict["pulidas"] = [["polished", "adjective"], ["well-polished", "adjective"], ["refined", "adjective"], ["polishing", "noun"]]
        self.custom_dict["soldadas"] = [["soldier", "noun"]]
        self.custom_dict["fláccidas"] = [["flaccid", "adjective"], ["flabby", "adjective"]]
        ...
        self.custom_dict["asombrosa"] = [["astonishing", "adjective"], ["amazing", "noun"]]
        self.custom_dict["bicloruro"] = [["bichloride", " noun"]]
        self.custom_dict["piedras"] = [["stone", "noun"], ["rock", "noun"], ["hailstone", "noun"], ["hail", "noun"]]
        self.custom_dict["imantar"] = [["magnetize", "verb"]]
        self.custom_dict["imantados"] = [["magnetized", "adjective"]]
        self.custom_dict["josé"] = [["José", "noun"]]
        self.custom_dict["había"] = [["be", "verb"], ["there is", "verb"], ["there are", "verb"], ["have", "verb"]]
        ...
        self.custom_dict["enemiga"] = [["enemy", "noun"], ["opponent", "noun"], ["adversary", "noun"], ["enemy forces", "noun"], ["enemy", "adjective"], ["opposing", "adjective"]]
        self.custom_dict["xv"] = [["XV", "abbreviation"]]
        self.custom_dict["cotidiana"] = [["daily", "adjective"], ["quotidian", "adjective"], ["everyday", "adjective"], ["routine", "adjective"]]
        ...
        self.custom_dict["disuadirlo"] = [["dissuade", "verb"]]
        self.custom_dict["melquíades"] = [["Melquíades", "noun"]]
        self.custom_dict["del"] = [["from the", "preposition"], ["of the", "preposition"]]
        self.custom_dict["gitanos"] = [["Gypsies", "noun"]]
        self.custom_dict["minúsculos"] = [["tiny", "adjective"], ["minor", "adjective"], ["trivial", "adjective"]]
        self.custom_dict["inmensa"] = [["immense", "adjective"], ["great", "adjective"], ["enormous", "adjective"], ["huge", "adjective"], ["gigantic", "adjective"], ["humungous", "adjective"], ["obese", "adjective"]]
        self.custom_dict["desmedrado"] = [["impaired", "adjective"], ["reduced", "adjectie"], ["puny", "adjective"], ["feeble", "adjective"]]
        self.custom_dict["gigantesca"] = [["gigantic", "adjective"]]
        self.custom_dict["cañabrava"] = [["reed", "unknown"]]
        self.custom_dict["seca"] = [["dry", "adjective"]]
        self.custom_dict["animales"] = [["animal", "noun"], ["beast", "noun"], ["brute", "noun"], ["violent", "adjective"], ["wild", "adjective"], ["crazy", "adjective"], ["lunatic", "noun"]]
